...
<!-- Please read the https://github.com/linuxserver/docker-mylar3/blob/nightly/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/mylar3:nightly` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/mylar3:nightly`
...
* Update the image: `docker pull lscr.io/linuxserver/mylar3:nightly`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/mylar3:nightly .
```
